...
def mnist_tutorial(train_start=0, train_end=60000, test_start=0,
    ...
    # graph
    """
    This file has cross attack using JSMA examples on model trained with,
    adversarial examples created from FGSM.
    """

    with np.load("adversarial_mnist_test_from_1500.npz") as data:
        adv_X_test, adv_Y_test, adv_clean_Y_test, adv_clean_X_test = data['adv_examples'], data['adv_targets'], data[
            'adv_clean_labels'], data['adv_clean_examples']
    ...
    print('Test accuracy on adversarial examples of jsma: %0.4f\n' % acc)
    report.clean_train_adv_eval = acc
