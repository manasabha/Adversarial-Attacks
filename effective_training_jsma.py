...
"""
Adversarial training done as per cost function in Ian Goodfellow's paper on adversarial
examples.
"""


def effective_train_jsma(train_start=0, train_end=50, test_start=0,
                        test_end=500, viz_enabled=False, nb_epochs=6,
